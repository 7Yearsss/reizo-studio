...
export default function CustomTitleBar() {
  ...
  return (
    <header className="titlebar flex h-10 shrink-0 items-center bg-sidebar select-none">
      ...
      <div ref={(el) => setTitleBarSlot('center', el)} className="titlebar-no-drag flex min-w-0 flex-1 items-center" />
      <div ref={(el) => setTitleBarSlot('right', el)} className="titlebar-no-drag ml-auto flex items-center" />
